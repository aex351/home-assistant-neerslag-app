...
class CombiCard extends LitElement {
  ...
  setConfig(config) {
    ...
    if (!config.entity && !config.entities) {
      throw new Error(
        "You need to define an entity or a list of entities. See readme file for available entities (sensors)"
      );
    }
    this._config = config;
    ...
    if (!stateObj && !stateMultiObj) {
      return html`
        ...
        <ha-card>
          ...
          <div class="not-found">Entity or Entities not available.</div>
        ...
        <ha-card>
          ...
          <div id="plotGraphCard">
            <div class="not-found">
              ...
              This integration/plugin is known for causing problems with the
              Neerslag Card. Please remove it from your Home Assistant
              installation and filesystem.
            </div>
          </div>
        </ha-card>
      `;
      ...
      if (propName == "hass") {
        if (typeof oldValue != "undefined") {
          ...
          if (this._config.entity) {
            ...
            if (
              this.hass.states[this._config.entity].attributes.data !==
              oldValue.states[this._config.entity].attributes.data
            ) {
          ...
          if (this._config.entities) {
            for (const entity of this._config.entities) {
              //console.log(entity)
              if (
                this.hass.states[entity].attributes.data !==
                oldValue.states[entity].attributes.data
              ) {
                //  console.log("data has changed, lets update")
                //  console.log(entity)
                this.updateGrafiek();
  ...
  makeGraph() {
    ...
    var primaryColor = convertToHexIfNeeded(
      style.getPropertyValue("--primary-color")
    );
    var accentColor = convertToHexIfNeeded(
      style.getPropertyValue("--accent-color")
    );
    var primaryTextColor = convertToHexIfNeeded(
      style.getPropertyValue("--primary-text-color")
    );
    var secondaryTextColor = convertToHexIfNeeded(
      style.getPropertyValue("--secondary-text-color")
    );
    ...
    if (this.myChart) {
      ...
      this.renderRoot
        .getElementById("neerslagChartContainer")
        .appendChild(canvas);
    }
    ...
    if (!this.myChart) {
      ...
      this.myChart = new Chart(ctx, {
        type: "line",
        options: {
          backgroundColor: [primaryColor.replace(" ", "") + percentToHex(20)],
  ...
  updateGrafiek() {
    ...
    this.myChart.data.labels =
      this.prepareChartDataSets().getChartsDataAlsArray()[0][0];
...
!(function (t, e) {
  ...
  function d(t, o, n) {
    const i = (function (t, o) {
      ...
      for (const e of o)
        e.scaleID === i
          ? c(e, t, ["value", "endValue"], s)
          : e[r] === i && c(e, t, [n + "Min", n + "Max", n + "Value"], s);
      return s;
    })(o, n);
  ...
  const u = (t, e, o) => Math.min(o, Math.max(e, t));
  function f(t, e, o) {
    for (const n of Object.keys(t)) t[n] = u(t[n], e, o);
    return t;
  }
  function b(t, e, { x: o, y: n, width: i, height: r }, s) {
    const a = s / 2 || 0;
  ...
  const p = (t) => "string" == typeof t && t.endsWith("%"),
    g = (t) => u(parseFloat(t) / 100, 0, 1);
  function w(t, e) {
    return "start" === e ? 0 : "end" === e ? t : p(e) ? g(e) * t : t / 2;
  }
  function m(t, e) {
    return "number" == typeof e ? e : p(e) ? g(e) * t : t;
  }
  function v(t) {
    return e.isObject(t)
      ? {
  ...
  function k(t, o) {
    const n = o.content;
    if (C(n))
      return { width: m(n.width, o.width), height: m(n.height, o.height) };
  ...
  function j(t, o, n) {
    const i = n.content;
    if (C(i)) return void t.drawImage(i, o.x, o.y, o.width, o.height);
  ...
  function T(t, e) {
    ...
    let s = o.width / 2,
      a = o.height / 2;
    return (
      i && (s = I(i, e.xValue, s)), r && (a = I(r, e.yValue, a)), { x: s, y: a }
    );
  }
  function R(t, e) {
    ...
    if (!o && !n) return {};
    const d = W(o, { min: e.xMin, max: e.xMax, start: r, end: a });
    (r = d.start), (a = d.end);
    const l = W(n, { min: e.yMin, max: e.yMax, start: i, end: s });
    return (
      (i = l.start),
      (s = l.end),
  ...
  class Y extends t.Element {
    ...
    getCenterPoint(t) {
      return A(this.getProps(["x", "y", "width", "height"], t));
    }
    draw(t) {
      t.save(), O(t, this, this.options), t.restore();
    }
    drawLabel(t) {
  ...
  function H(t, e) {
    ...
    return o + d / 2 + a + r + w(n - d - o - r - s - e.size, i);
  }
  (Y.id = "boxAnnotation"),
    (Y.defaults = {
      adjustScaleRange: !0,
    ...
    (Y.defaultRoutes = { borderColor: "color", backgroundColor: "color" }),
    (Y.descriptors = { label: { _fallback: !0 } });
  const N = (t, e, o) => ({
      x: t.x + o * (e.x - t.x),
      y: t.y + o * (e.y - t.y),
    }),
    _ = (t, e, o) => N(e, o, Math.abs((t - e.y) / (o.y - e.y))).x,
    z = (t, e, o) => N(e, o, Math.abs((t - e.x) / (o.x - e.x))).y,
    L = (t) => t * t,
    B = 0.001;
  function $(
    { x: t, y: e, x2: o, y2: n },
  ...
  function F({ x: t, y: e }, o, { top: n, right: i, bottom: r, left: s }) {
    return (
      t < s && ((e = z(s, { x: t, y: e }, o)), (t = s)),
      t > i && ((e = z(i, { x: t, y: e }, o)), (t = i)),
      e < n && ((t = _(n, { x: t, y: e }, o)), (e = n)),
      e > r && ((t = _(r, { x: t, y: e }, o)), (e = r)),
      { x: t, y: e }
    );
  }
  class J extends t.Element {
    ...
    isOnLabel(t, e, o) {
      ...
      const {
        ...
        u = s / 2 + h;
      return (
        d >= n - c - B && d <= n + c + B && l >= i - u - B && l <= i + u + B
      );
    }
    inRange(t, e, o) {
      const n = L(this.options.borderWidth / 2);
    ...
    draw(t) {
      ...
      if ((t.save(), !D(t, r))) return t.restore();
      P(t, r);
    ...
    drawLabel(t, e) {
      ...
      O(t, { x: -i / 2, y: -r / 2, width: i, height: r }, l);
      j(
        t,
        {
    ...
    resolveElementProperties(t, o) {
      ...
      if (n)
        ...
        e && ((a = I(e, o.xMin, a)), (l = I(e, o.xMax, l))),
          n && ((s = I(n, o.yMin, s)), (d = I(n, o.yMax, d)));
      }
      const h = $({ x: a, y: s, x2: l, y2: d }, t.chartArea)
          ? (function (t, e, o) {
              const { x: n, y: i } = F(t, e, o),
                { x: r, y: s } = F(e, t, o);
              return {
                x: n,
                y: i,
              ...
              u = (function (t, o, n, i) {
                const { width: r, height: s, padding: a } = n,
                  ...
                  b = (function (t, e, o, n) {
                    ...
                    i =
                      "start" === e.position
                        ? U({ w: t.x2 - t.x, h: t.y2 - t.y }, o, e, r)
                        : "end" === e.position
                        ? 1 - U({ w: t.x - t.x2, h: t.y - t.y2 }, o, e, r)
                        : w(1, e.position);
                    return i;
  ...
  (J.defaults = {
    ...
    (J.defaultRoutes = { borderColor: "color" });
  class Z extends t.Element {
    inRange(t, o, n) {
    ...
    draw(t) {
      ...
      t.save(),
        t.translate(r.x, r.y),
        i.rotation && t.rotate(e.toRadians(i.rotation)),
        P(t, this.options),
        t.beginPath(),
        (t.fillStyle = i.backgroundColor);
      const s = D(t, i);
      t.ellipse(0, 0, n / 2, o / 2, e.PI / 2, 0, 2 * e.PI),
        t.fill(),
  ...
  (Z.id = "ellipseAnnotation"),
    ...
    (Z.defaultRoutes = { borderColor: "color", backgroundColor: "color" });
      ...
      !(function (t, e) {
        ...
        const { separatorStart: a, separatorEnd: d } = (function (t, e) {
          ...
          { sideStart: l, sideEnd: h } = (function (t, e, o) {
            ...
            let l, h;
            "left" === e || "right" === e
              ? ((l = { x: o.x, y: n + m(r, a) }), (h = { x: l.x + d, y: l.y }))
              : ((l = { x: o.x + m(i, a), y: o.y }),
                (h = { x: l.x, y: l.y + d }));
        ...
        this.boxVisible && O(t, this, r),
        j(t, { x: e, y: o, width: n, height: i }, r);
    }
    resolveElementProperties(t, o) {
      const n = M(o) ? T(t, o) : A(R(t, o)),
        ...
        s = (function (t, e, o, n) {
          const i = e.width + n.width + o.borderWidth,
            ...
            s = v(o.position);
          return {
            x: et(t.x, i, o.xAdjust, s.x),
            y: et(t.y, r, o.yAdjust, s.y),
            width: i,
            height: r,
          };
        })(n, r, o, i),
        a = e.color(o.backgroundColor),
        d = {
          boxVisible: o.borderWidth > 0 || (a && a.valid && a.rgb.a > 0),
          pointX: n.x,
          pointY: n.y,
          ...s,
          labelX: s.x + i.left + o.borderWidth / 2,
          labelY: s.y + i.top + o.borderWidth / 2,
          labelWidth: r.width,
  ...
  function et(t, e, o = 0, n) {
    return t - w(e, n) + o;
  }
  (tt.id = "labelAnnotation"),
    (tt.defaults = {
      adjustScaleRange: !0,
    ...
    (tt.defaultRoutes = { borderColor: "color" });
  class ot extends t.Element {
    inRange(t, e, o) {
    ...
    draw(t) {
      ...
      t.save(), (t.fillStyle = o.backgroundColor), P(t, o);
      const i = D(t, o);
      (o.borderWidth = 0),
  ...
  (ot.id = "pointAnnotation"),
    ...
    (ot.defaultRoutes = { borderColor: "color", backgroundColor: "color" });
  class nt extends t.Element {
    ...
    draw(t) {
      ...
      t.save(), t.beginPath(), (t.fillStyle = o.backgroundColor), P(t, o);
      const n = D(t, o);
      let i = !0;
      for (const o of e)
    ...
    resolveElementProperties(t, o) {
      const { x: n, y: i, width: r, height: s } = E(t, o),
  ...
  const it = { box: Y, ellipse: Z, label: tt, line: J, point: ot, polygon: nt };
  Object.keys(it).forEach((e) => {
    t.defaults.describe(`elements.${it[e].id}`, {
  ...
  var st = {
      ...
      !(function (t, r, s) {
        ...
        (function (o, n, i, r) {
          const s = (function (e, o, n) {
              if ("reset" === n || "none" === n || "resize" === n) return at;
          ...
          for (let t = 0; t < a.length; t++) {
            const n = a[t],
              i = ht(d, t, n.type),
              r = n.setContext(ft(o, i, n)),
              l = i.resolveElementProperties(o, r);
            (l.skip = isNaN(l.x) || isNaN(l.y)),
              "elements" in l && (lt(i, l, r, s), delete l.elements),
    ...
    beforeDatasetsDraw(t, e, o) {
      bt(t, "beforeDatasetsDraw", o.clip);
    },
    afterDatasetsDraw(t, e, o) {
      bt(t, "afterDatasetsDraw", o.clip);
    },
    beforeDraw(t, e, o) {
      bt(t, "beforeDraw", o.clip);
    },
    afterDraw(t, e, o) {
      bt(t, "afterDraw", o.clip);
    },
    beforeEvent(t, e, o) {
      r(rt.get(t), e.event, o);
    },
    destroy(t) {
      rt.delete(t);
    },
    _getState: (t) => rt.get(t),
    defaults: {
      animations: {
        numbers: {
          properties: [
    ...
    descriptors: {
      ...
      annotations: {
        _allKeys: !1,
        _fallback: (t, e) => `elements.${it[dt(e.type)].id}`,
      },
    },
    additionalOptionScopes: [""],
  };
  const at = { update: Object.assign };
  function dt(t = "line") {
    return it[t]
      ? t
  ...
  function lt(t, { elements: e, initProperties: o }, n, i) {
  ...
  function ct(t) {
    const e = it[dt(t.type)],
      o = {};
    (o.id = t.id),
      (o.type = t.type),
      (o.drawTime = t.drawTime),
      Object.assign(o, ut(t, e.defaults), ut(t, e.defaultRoutes));
  ...
  function bt(t, o, n) {
    const { ctx: i, chartArea: r } = t,
      { visibleElements: s } = rt.get(t);
    n && e.clipArea(i, r),
      xt(i, s, o),
      (function (t, o, n) {
        for (const i of o) e.isArray(i.elements) && xt(t, i.elements, n);
      })(i, s, o),
      n && e.unclipArea(i),
      s.forEach((t) => {
